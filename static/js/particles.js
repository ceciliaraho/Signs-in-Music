...
fetch('/data/song_parameters.json')
  ...
  .then(jsonString => {
    ...
    const sum = energy_array.reduce((acc, val) => acc + val, 0);
...
var pJS = function(tag_id, params){
  ...
  pJS.fn.particlesUpdate = function(){
    ...
    for(var i = 0; i < pJS.particles.array.length; i++){
      ...
      /* move the particle */
      if(pJS.particles.move.enable){
        var ms = pJS.particles.move.speed * multiplierSpeed;
        p.x += p.vx * ms;
        p.y += p.vy * ms;
      }
