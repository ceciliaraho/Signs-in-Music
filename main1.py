    ...
    for action in actions:
        ...
        for sequence in range(no_sequences):
            ...
            for frame_num in range(sequence_length):
                ...
                # Applica l'aumento dei dati
                #augmented_frame = augment_data(frame)
                ...
                aug_type = random.choice(['rotation', None])  # Scegli casualmente la trasformazione da applicare
                keypoints = extract_keypoints(results, aug_type)
